...
# "17_analysis_of_response_profile_trauma.R", and
...
# Fit model
model <- gls(diverthours ~ emslevel * year,
...
# Save results
saveRDS(results,
        "models/analysis_of_response_profile/emslevel.rds")

# emslevel:year p-value < 0.05 so we have sufficient evidence to conclude
# that the patterns of change differ between the groups and thus
# an emslevel:year interaction term was included in the model fitted using GEE
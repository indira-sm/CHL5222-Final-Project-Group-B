...
# ambulance diversion hours by trauma level.
...
# "13_diverthours_histogram.R", "14_overdispersion_check_tibble.R", and
...
figure <- ambulance %>%
  ...
  labs(
    title =
      "Mean trajectory for the ambulance diversion hours by trauma level",
    x = "Year",
...
# Save figure
saveRDS(figure,
        "figures/diverthours_trajectory_by_trauma.rds")